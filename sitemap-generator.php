<?php
	...
	// Example: "https://gowen/dontlist" 
	$skip = array (
					"https://YOURWEBSITE/YYY/",
					"https:/YOURWEBSITE/XXX/",
				  );
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible; Gowen PHP XML Sitemap Generator/" . VERSION . ", https://gowen.fr)";
	...
	fwrite ($pf, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" .
				 "<?xml-stylesheet type=\"text/xsl\" href=\"http://kvngch.github.io/PHP-XML-Sitemap-Generator/xml-sitemap.xsl\"?>\n" .
				 "<!-- Created with GOWEN PHP XML Sitemap Generator " . VERSION . " http://gowen.fr -->\n" .
